    ...
    <ul class="pagination justify-content-center">
        <c:choose>
            ...
            <c:otherwise>
                <li class="page-item link-dark">
                    <a class="page-link link-dark" href="/item/nightMealPaging?page=${paging.page-1}">[이전]</a>
                </li>
            </c:otherwise>
        </c:choose>
        <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
            <c:choose>
                ...
                <c:otherwise>
                    <li class="page-item link-dark">
                        <a class="page-link link-dark" href="/item/nightMealPaging?page=${i}">${i}</a>
                    </li>
                </c:otherwise>
            </c:choose>
        </c:forEach>
        <c:choose>
            ...
            <c:otherwise>
                <li class="page-item link-dark">
                    <a class="page-link link-dark" href="/item/nightMealPaging?page=${paging.page+1}">[다음]</a>
                </li>
            </c:otherwise>
        </c:choose>
    </ul>
